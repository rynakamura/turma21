programa
{
	...
	//Ideia para adicionar creditos a qualquer momento
	cadeia inserirNota =" Digite I para inclusﾃ｣o de notas ou R para retirada de notas: "
	real notaExtra = 0.00
	real usoExtra=0.00
	...
	*/
	...
	escreva("slogan \n\n")
		...
		leia(tipoMovimento)
			...
			}senao se((tipoMovimento=='Z' ou tipoMovimento=='z')e (tipoConta==5 ou tipoConta==4 ou tipoConta==3) ){
				escreva("Pontos totais : "+pontosTotais+"\n")
